...
export class ColumnDefinition extends Entity implements Parsable {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {...super.getFieldDeserializers(),
            "boolean": n => { this.boolean = n.getObjectValue<BooleanColumn>(createBooleanColumnFromDiscriminatorValue); },
            "calculated": n => { this.calculated = n.getObjectValue<CalculatedColumn>(createCalculatedColumnFromDiscriminatorValue); },
            "choice": n => { this.choice = n.getObjectValue<ChoiceColumn>(createChoiceColumnFromDiscriminatorValue); },
            "columnGroup": n => { this.columnGroup = n.getStringValue(); },
            "contentApprovalStatus": n => { this.contentApprovalStatus = n.getObjectValue<ContentApprovalStatusColumn>(createContentApprovalStatusColumnFromDiscriminatorValue); },
            "currency": n => { this.currency = n.getObjectValue<CurrencyColumn>(createCurrencyColumnFromDiscriminatorValue); },
            "dateTime": n => { this.dateTime = n.getObjectValue<DateTimeColumn>(createDateTimeColumnFromDiscriminatorValue); },
            "defaultValue": n => { this.defaultValue = n.getObjectValue<DefaultColumnValue>(createDefaultColumnValueFromDiscriminatorValue); },
            "description": n => { this.description = n.getStringValue(); },
            "displayName": n => { this.displayName = n.getStringValue(); },
            "enforceUniqueValues": n => { this.enforceUniqueValues = n.getBooleanValue(); },
            "geolocation": n => { this.geolocation = n.getObjectValue<GeolocationColumn>(createGeolocationColumnFromDiscriminatorValue); },
            "hidden": n => { this.hidden = n.getBooleanValue(); },
            "hyperlinkOrPicture": n => { this.hyperlinkOrPicture = n.getObjectValue<HyperlinkOrPictureColumn>(createHyperlinkOrPictureColumnFromDiscriminatorValue); },
            ...
            "lookup": n => { this.lookup = n.getObjectValue<LookupColumn>(createLookupColumnFromDiscriminatorValue); },
            "name": n => { this.name = n.getStringValue(); },
            "number": n => { this.number = n.getObjectValue<NumberColumn>(createNumberColumnFromDiscriminatorValue); },
            "personOrGroup": n => { this.personOrGroup = n.getObjectValue<PersonOrGroupColumn>(createPersonOrGroupColumnFromDiscriminatorValue); },
            ...
            "sourceColumn": n => { this.sourceColumn = n.getObjectValue<ColumnDefinition>(createColumnDefinitionFromDiscriminatorValue); },
            "sourceContentType": n => { this.sourceContentType = n.getObjectValue<ContentTypeInfo>(createContentTypeInfoFromDiscriminatorValue); },
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeObjectValue<ContentTypeInfo>("sourceContentType", this.sourceContentType);
