...
export class ContentType extends Entity implements Parsable {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {...super.getFieldDeserializers(),
            ...
            "base": n => { this.base = n.getObjectValue<ContentType>(createContentTypeFromDiscriminatorValue); },
            "baseTypes": n => { this.baseTypes = n.getCollectionOfObjectValues<ContentType>(createContentTypeFromDiscriminatorValue); },
            "columnLinks": n => { this.columnLinks = n.getCollectionOfObjectValues<ColumnLink>(createColumnLinkFromDiscriminatorValue); },
            "columnPositions": n => { this.columnPositions = n.getCollectionOfObjectValues<ColumnDefinition>(createColumnDefinitionFromDiscriminatorValue); },
            ...
            "documentSet": n => { this.documentSet = n.getObjectValue<DocumentSet>(createDocumentSetFromDiscriminatorValue); },
            "documentTemplate": n => { this.documentTemplate = n.getObjectValue<DocumentSetContent>(createDocumentSetContentFromDiscriminatorValue); },
            ...
            "order": n => { this.order = n.getObjectValue<ContentTypeOrder>(createContentTypeOrderFromDiscriminatorValue); },
