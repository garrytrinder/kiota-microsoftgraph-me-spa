...
export class OnenotePage extends OnenoteEntitySchemaObjectModel implements Parsable {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {...super.getFieldDeserializers(),
            ...
            "links": n => { this.links = n.getObjectValue<PageLinks>(createPageLinksFromDiscriminatorValue); },
            ...
            "parentSection": n => { this.parentSection = n.getObjectValue<OnenoteSection>(createOnenoteSectionFromDiscriminatorValue); },
