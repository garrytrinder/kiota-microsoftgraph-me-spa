...
export class OnenoteSection extends OnenoteEntityHierarchyModel implements Parsable {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {...super.getFieldDeserializers(),
            ...
            "links": n => { this.links = n.getObjectValue<SectionLinks>(createSectionLinksFromDiscriminatorValue); },
            "pages": n => { this.pages = n.getCollectionOfObjectValues<OnenotePage>(createOnenotePageFromDiscriminatorValue); },
            "pagesUrl": n => { this.pagesUrl = n.getStringValue(); },
            "parentNotebook": n => { this.parentNotebook = n.getObjectValue<Notebook>(createNotebookFromDiscriminatorValue); },
            "parentSectionGroup": n => { this.parentSectionGroup = n.getObjectValue<SectionGroup>(createSectionGroupFromDiscriminatorValue); },
        };
    };
    /**
