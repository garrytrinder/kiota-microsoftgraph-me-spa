...
export class Permission extends Entity implements Parsable {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {...super.getFieldDeserializers(),
            ...
            "invitation": n => { this.invitation = n.getObjectValue<SharingInvitation>(createSharingInvitationFromDiscriminatorValue); },
            "link": n => { this.link = n.getObjectValue<SharingLink>(createSharingLinkFromDiscriminatorValue); },
