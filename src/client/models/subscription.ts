...
export class Subscription extends Entity implements Parsable {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {...super.getFieldDeserializers(),
            ...
            "changeType": n => { this.changeType = n.getStringValue(); },
            "clientState": n => { this.clientState = n.getStringValue(); },
            "creatorId": n => { this.creatorId = n.getStringValue(); },
            "encryptionCertificate": n => { this.encryptionCertificate = n.getStringValue(); },
            ...
            "includeResourceData": n => { this.includeResourceData = n.getBooleanValue(); },
            "latestSupportedTlsVersion": n => { this.latestSupportedTlsVersion = n.getStringValue(); },
            "lifecycleNotificationUrl": n => { this.lifecycleNotificationUrl = n.getStringValue(); },
            "notificationQueryOptions": n => { this.notificationQueryOptions = n.getStringValue(); },
            "notificationUrl": n => { this.notificationUrl = n.getStringValue(); },
            "notificationUrlAppId": n => { this.notificationUrlAppId = n.getStringValue(); },
